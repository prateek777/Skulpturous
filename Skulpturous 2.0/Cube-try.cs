...
{
    public class KinectCubesJig : KinectPointCloudJig
    {
    ...
    public class KinectCubeCommands
    {
        [CommandMethod("ADNPLUGINS", "KINEXT3", CommandFlags.Modal)]
        public void ImportFromKinect()
        {
            ...
            KinectCubesJig kj =
              new KinectCubesJig(doc, tr, 0.1, 10);
