...
{
    public class KinectrotateCubesJig : KinectPointCloudJig
    {
    ...
    public class KinectCuberotateCommands
    {
        [CommandMethod("ADNPLUGINS", "KINrotate", CommandFlags.Modal)]
        public void ImportFromKinect()
        {
            ...
            KinectrotateCubesJig kj =
              new KinectrotateCubesJig(doc, tr, 0.1, 10);
