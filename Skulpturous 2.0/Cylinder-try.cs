...
{
    public class KinectCylinderJig : KinectPointCloudJig
    {
        // Our transient solids (cursor sphere & tube) are yellow

        const short transSolColor = 5;

        // Our final solids will be green

        const short finalSolColor = 5;
    ...
    public class KinectCylinderCommands
    {
        [CommandMethod("ADNPLUGINS", "KINEXT5", CommandFlags.Modal)]
        public void ImportFromKinect()
        {
            ...
            KinectCylinderJig kj =
              new KinectCylinderJig(doc, tr, 0.1, 10);
