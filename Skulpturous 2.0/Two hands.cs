...
{
    public class KinectHandsJig : KinectPointCloudJig
    {
        ...
        private bool _drawingr;     // Drawing mode active
        private bool _drawingl;  

        public KinectHandsJig(
                        ...
                        foreach (Skeleton data in skels)
                        {
                            ...
                            )
                            {
                                ...
                                else
                                {
                                    ...
                                    _drawingr = (leftHand.Z < leftHip.Z) && (rightHand.Z > leftHip.Z);

                                    _drawingl = (leftHand.Z > leftHip.Z) && (rightHand.Z < leftHip.Z);
                                }
                                ...
                                else if (_drawingl)
                                {
                                    ...
                                    if (_vertices.Count > 0)
                                    {
                                        ...
                                        Point3d lastVert =
                                          _vertices[_vertices.Count - 1];
                                        if (
                                          lastVert.DistanceTo(leftHand) > _profSide * 4
                                        )
                                        {
                                            // Add the new vertex to our list

                                            _vertices.Add(leftHand);
                                        }
                                    }
                                    else
                                    {
        ...
        protected override bool WorldDrawData(WorldDraw draw)
        {
            ...
            if (_drawingl || _drawingr)
            {
                ...
                draw.SubEntityTraits.Color = 3; // ADD ColorIndex;
    ...
    public class KinectHandsCommands
    {
        [CommandMethod("ADNPLUGINS", "KINEXT10", CommandFlags.Modal)]
        public void ImportFromKinect()
        {
            ...
            KinectHandsJig kj =
              new KinectHandsJig(doc, tr, 0.1, 10);
