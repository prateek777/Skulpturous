...
{
    public class KinectextrudeCubesJig : KinectPointCloudJig
    {
                                ...
                                else
                                {
                                  ...
                                  /*  _changeaxis = (leftHand.Z > leftHip.Z &&
                                    ...
                                    */
                                    ...
                                    _isExtrude = (leftHand.Z < leftHip.Z &&
                                       rightHand.Z > leftHip.Z &&
                                       Math.Abs(leftHand.Z - rightHand.Z) < 0.5);
                                    _drawing = false;
                                }
        ...
        protected override bool WorldDrawData(WorldDraw draw)
        {
         ...
         //   if (_isExtrude)
           // {
                ...
                cube.ExtrudeFaces(AcArray<AcDbSubentId *>& {1},_profSide,1.6);
            //}
    ...
    public class KinectCubeextrudeCommands
    {
        [CommandMethod("ADNPLUGINS", "KINextrude", CommandFlags.Modal)]
        public void ImportFromKinect()
        {
            ...
            KinectextrudeCubesJig kj =
              new KinectextrudeCubesJig(doc, tr, 0.1, 10);
