...
{
    public class KinectSwitchJig : KinectPointCloudJig
    {
    ...
    public class KinectSwitchCommands
    {
        [CommandMethod("ADNPLUGINS", "KINSwitch", CommandFlags.Modal)]
        public void ImportFromKinect()
        {
            ...
            KinectSwitchJig kj =
              new KinectSwitchJig(doc, tr, 0.1, 10);
