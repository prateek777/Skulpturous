...
{
    public class KinectTwothingsJig : KinectPointCloudJig
    {
            ...
            if (_resizing)
            {
                using (Solid3d cube = new Solid3d())
                {
                    try
                    {
                        ...
                        cone.CreateFrustum(20.0, 20.0, 20.0, 0.0); //(_profSide, _profSide, _profSide, 0.0);

                        if (cone != null)
                        {
                            Point3d _resizeLocation1 = new Point3d(20.0, 20.0, 20.0);

                            cone.TransformBy(
                             Matrix3d.Displacement(
                               _resizeLocation1 - Point3d.Origin
                             )
                           );
                          ...
                          // Vector3d new1 = new Vector3d(0.0, 0.0, 100.0);
                        ...
                        if (cone != null)
                        {
                            /*Vector3d new1 = new Vector3d(50,0,0);
                            cone.TransformBy(
                              Matrix3d.Displacement(
                                _resizeLocation - Point3d.Origin + new1
                              )
                            ); */
    ...
    public class KinectTwothingsCommands
    {
        [CommandMethod("ADNPLUGINS", "KINEXT9", CommandFlags.Modal)]
